...
#define SERVO_CENTER_POSITION 90    // Default servo center position
#define SERVO_STEP_ANGLE 30         // Servo movement step angle
#define MOTOR_DEFAULT_SPEED 150     // Default motor speed
#define ULTRASONIC_MIN_DISTANCE 2   // Minimum valid ultrasonic reading (cm)
#define ULTRASONIC_MAX_DISTANCE 150 // Maximum ultrasonic detection range (cm)
#define ULTRASONIC_TIMEOUT_MS 30    // Ultrasonic sensor timeout (ms)
#define BATTERY_LOW_THRESHOLD 7.0   // Low battery voltage threshold
#define JSON_BUFFER_SIZE 200        // JSON document buffer size
